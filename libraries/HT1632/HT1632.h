...
class HT1632LEDMatrix : public Print {
 ...
 uint8_t height();
  ...
  void drawCharRows(uint8_t x, uint8_t y, char c, uint16_t color, uint8_t size, uint8_t startrow=0, uint8_t endrow=99);
  void drawCharTx(uint8_t x, uint8_t y, char c, char d, uint16_t color, uint8_t size, uint8_t row);
